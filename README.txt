...
a persistence unit "WSParkingRamirezBarzalloPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "WSParkingRamirezBarzallo/pom.xml":
...
artifact ("WSParkingRamirezBarzallo.war") is already built. You can build
